...
# Token telegran bot
bot_token = '1033465219:AAFXnhe_eX-nhlZZahfv6mH1NVRE5fp3o9o' # токен бота
CHANNEL_ID = 0 # id канала куда будет отсылаться информация, ид без -100 в начале (например: 124873248) - указать заместо нуля

# ID admin
admin_id = 907680376 # id админа - указать заместо нуля

bot_login = 'TokenSkamBot' # логин бота
ref_percent = 5 # Процент реферальной системы

QIWI_NUMBER = '+79152278657'    # номер киви
